...
public class ConnectionRateStatService {
    ...
    private List<Criteria> createCriteriaForByDevice(AggregationResults<Document> basicConditions, Object target, Condition cond) {
        List<Criteria> list = new ArrayList();
    ...
    private final String getDeviceNameById(String deviceId) {
        if ( devices.isEmpty() ) {
            setDeviceInfo();
        }
